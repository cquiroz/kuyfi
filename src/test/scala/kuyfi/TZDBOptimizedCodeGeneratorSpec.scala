...
class TZDBOptimizedCodeGeneratorSpec extends FlatSpec with Matchers {
  ...
  "TZDB Code generator" should
    ...
    it should "import a top level package" in {
      treeToString(exportTzdb("2018a", "org.threeten.bp", "org.threeten.bp", link1.liftC[Row] :: link2.liftC[Row] :: zone1.liftC[Row] :: Nil, _ => true)) should include ("import scala.scalajs.js")
    }
