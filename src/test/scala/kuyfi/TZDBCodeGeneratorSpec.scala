...
class TZDBCodeGeneratorSpec extends FlatSpec with Matchers {
  ...
  "TZDB Code generator" should
    ...
    it should "import a top level package" in {
      treeToString(exportTzdb("org.threeten.bp", "org.threeten.bp", link1.liftC[Row] :: link2.liftC[Row] :: zone1.liftC[Row] :: Nil, _ => true)) should include ("import org.threeten.bp._")
    }
